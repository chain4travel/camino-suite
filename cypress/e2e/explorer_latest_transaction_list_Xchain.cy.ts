            ...
            inputs: [
                {
                    output: {
                        ...
                        stakeLocktime: 0,
                        threshold: 1,
                        addresses: ['kopernikus102uap4au55t22m797rr030wyrw0jlgw25ut8vj'],
                        caddresses: null,
                        timestamp: '2023-02-23T15:51:43Z',
                        redeemingTransactionID:
                            '2k4d9Ljm6R5G9a27c22KKwB5V9VdkisqzWMkp68d9cTMVX5Br9',
                        chainID: 'jvYyfQTxGMJLuGWa55kdP2p2zSUYsQ5Raupu4TW34ZAUBAbtq',
                    ...
                    credentials: [
                        {
                            ...
                            signature:
                                '54feuCfa9drJNChsXibzJ4fWD9gHYknyIPfz81bkBzBxoK7lhVWh+fryoN7zvCqpTwjDaY1n3foLNAJ5SHAHhQA=',
                        },
                    ],
                },
            ],
...
describe('latest transaction list Xchainet', { tags: ['@explorer', '@suite'] }, () => {
    ...
    it('latest transaction list Xchain', () => {
        ...
        cy.get('[data-cy="app-selector-Explorer"] > .css-8atqhb > .MuiBox-root').should(
            'be.visible',
        )
        ...
        cy.wait('@ValidatorsInfo').then(() => {
            ...
            cy.get(
                ':nth-child(1) > .MuiPaper-root > .MuiCardContent-root > .MuiBox-root > .MuiTypography-h4',
            )
                .invoke('text')
                .then(textV => {
        ...
        cy.wait('@txcount').then(() => {
            ...
            cy.get(
                ':nth-child(2) > .MuiPaper-root > .MuiCardContent-root > .MuiBox-root > .MuiTypography-root',
            )
                .invoke('text')
                .then(textCount => {
        ...
        cy.wait('@transactions').then(() => {
            ...
            cy.get('.MuiGrid-grid-xs-4 > .MuiChip-root > .MuiChip-label')
                .invoke('text')
                .then(textType => {
            ...
            cy.get(
                ':nth-child(1) > .MuiGrid-grid-md-8 > .MuiGrid-grid-lg-8 > :nth-child(1) > [style="width: 100%;"] > .MuiGrid-grid-xs-9 > .MuiGrid-container > .MuiGrid-grid-xl-7 > a > .MuiTypography-root',
            )
                .invoke('text')
                .then(textFrom => {
            ...
            cy.get(
                ':nth-child(1) > .MuiGrid-grid-md-8 > .MuiGrid-grid-lg-8 > :nth-child(2) > [style="width: 100%;"] > .MuiGrid-grid-xs-9 > :nth-child(1) > .MuiGrid-grid-xl-7 > a > .MuiTypography-root',
            )
                .invoke('text')
                .then(textTo => {
            ...
            cy.get('[data-cy="cam-amount-From"]')
                .invoke('text')
                .then(textIF => {
                    let numberFix =
                        parseInt(transactionsBody.transactions[0].inputs[0].output.amount) /
                        1000000000
                    if (textIF == numberFix) {
            ...
            cy.get('[data-cy="cam-amount-To"]')
                .invoke('text')
                .then(textIT => {
                    let numberFix =
                        parseInt(transactionsBody.transactions[0].outputs[0].amount) / 1000000000
                    if (textIT == numberFix) {
            ...
            cy.get('[data-cy="cam-amount-Fees"]')
                .invoke('text')
                .then(textFee => {
        ...
        cy.wait('@txfee').then(() => {
            ...
            cy.get(
                ':nth-child(3) > .MuiPaper-root > .MuiCardContent-root > .MuiBox-root > .MuiTypography-root',
            )
                .invoke('text')
                .then(textF => {
