            ...
            cy.wait('@cblocks')
                ...
                .then(({ blocks }) => {
                    ...
                    cy.get('@latestBlocks')
                        ...
                        .find('>p')
                        .eq(1)
                        .should('have.text', blocks[0].hash)
                    cy.get('@latestBlocks')
                        .eq(4)
                        .find('h6')
                        .invoke('text')
                ...
                .then(transactions => {
                    cy.get('.MuiTableContainer-root')
                        ...
                        .each(($el, index) => {
                            ...
                            cy.get('@moreTxsBlock')
                                .eq(0)
                                .should('have.text', parseInt(tx.block, 16))
                            ...
                            cy.get('@moreTxsBlock').eq(6).find('h6').should('have.text', txGasFee)
                            ...
                            cy.get('@moreTxsBlock')
                                ...
                                .should(
                                    ...
                                    roundedToLocaleString(
                                        getDisplayAmount(parseInt(tx.value, 16)).value,
                                        abbreviate ? 4 : 20,
                                        abbreviate,
                                    ),
                                )
